...
export const CONTRACT_CONFIG = {
  registryContractId: process.env.NEXT_PUBLIC_REGISTRY_CONTRACT_ID || "CDO67GJ4XVFV3XIQNMU3IMIPTHFVLU7IJIKG4EO26GEHG6EU4Z5PGLWC",
  escrowContractId: process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID || "CBOLJ56TWJZ2FTK2QMJU2RX2OYTQ6SV55NFZBI7BIZCKNMWJFZYQ2AVJ",
  adminAddress: "GCPUZLCKI4NONG3ZLNUWKMTBZS3CO6SXFMHR2H2PGQHMENR4HL7HNMFD",
