...
export const CONTRACT_CONFIG = {
  registryContractId: process.env.NEXT_PUBLIC_REGISTRY_CONTRACT_ID || "CDJS5N376ZHLWV6J2GT67IHGP3KTRHI3PAWIIMYXSOKCKOYYQCJ4H26B",
  escrowContractId: process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID || "CCKV3SIQH4V3NVCD3DTUY4JJTNJA3VCNDMMUPWSPEJ664JN52HRZHOPO",
