...
export const CONTRACT_CONFIG = {
  registryContractId: process.env.NEXT_PUBLIC_REGISTRY_CONTRACT_ID || "CBTC47ML7FRSJILEG6NY6GGR3SH6X4I24NQIKMSHEVBNI3AM4OTYMJJC",
  escrowContractId: process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID || "CA36PO4NL6APAXFQMFRE55AEDXVZHILQOULY473KJA3FV5IJBCODLLWJ",
