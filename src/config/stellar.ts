...
export const CONTRACT_CONFIG = {
  registryContractId: process.env.NEXT_PUBLIC_REGISTRY_CONTRACT_ID || "CD3YZE3WECUWNHW7QKDOYYUCH6PZ3VP2GIR4HJDVREQ3PFBZR7P2CXCJ",
  escrowContractId: process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID || "CB5B33DB3GI5XTD4H7YNAKSR4PTE4675SIDNYA3TOJNGE3RXZ26TRVOD",
